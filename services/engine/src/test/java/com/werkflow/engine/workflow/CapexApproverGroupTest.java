...
class CapexApproverGroupTest extends WerkflowProcessTest {
    ...
    void setup() {
        ...
        managerGroup = dmnRunner.deploy("examples/tenants/default/dmn/capex-approver-resolution.dmn", "capex_manager_group");
        vpGroup      = dmnRunner.deploy("examples/tenants/default/dmn/capex-approver-resolution.dmn", "capex_vp_group");
        cfoGroup     = dmnRunner.deploy("examples/tenants/default/dmn/capex-approver-resolution.dmn", "capex_cfo_group");
    }
