...
| Next | Bug 3 (Tenant 500/Delete) or MVP release cut after user E2E tests feature branch |
| Branch | `feature/portal-design-audit` — **pending user E2E testing before merge to main** |
